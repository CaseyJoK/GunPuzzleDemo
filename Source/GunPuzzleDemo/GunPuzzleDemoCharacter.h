...
#include "GrowGun.h"
#include "PushGun.h"
#include "GunPuzzleDemoCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class AGunPuzzleDemoCharacter : public ACharacter
{
	GENERATED_BODY()
...
protected:
  ...
  TArray<TSubclassOf<AWeapon>> Inventory; //Creates an inventory to hold our 3 weapons
